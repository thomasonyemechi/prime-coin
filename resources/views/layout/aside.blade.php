<aside class="sidebar sidebar-default navs-rounded ">
    <div class="sidebar-header d-flex align-items-center justify-content-start">
        <a href="index.html" class="navbar-brand dis-none align-items-center">
            ...
            <ul class="navbar-nav iq-main-menu">
                ...
                <li class="nav-item ">
                    <a class="nav-link" aria-current="page" href="#">
                        ...
                        <span class="item-name">Buy PMC</span>
                    </a>
                </li>
                ...
                <li class="nav-item ">
                    <a class="nav-link" aria-current="page" href="#">
                        ...
                        <span class="item-name">Trasnfer</span>
                    </a>
                </li>
                ...
                <li class="nav-item ">
                    <a class="nav-link" aria-current="page" href="#">
                        ...
                        <span class="item-name">Make Trade</span>
                    </a>
                </li>
                ...
                <li class="nav-item ">
                    <a class="nav-link" aria-current="page" href="#">
                        ...
                        <span class="item-name">Funds Withdrwal</span>
                    </a>
                </li>
                ...
                <li class="nav-item ">
                    <a class="nav-link" aria-current="page" href="/wallet">
                        ...
                        <span class="item-name">Wallet Ssetting</span>
                    </a>
                </li>
