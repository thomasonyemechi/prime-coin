                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-5 col-md-10">
                            <div class="login-content">
                                ...
                                <span>Welcome To {{env('APP_NAME')}}! Please enter your details.</span>
                                <form action="#">
                                    @csrf
                                    <div class="form-grp">
                                    ...
                                    <div class="password-wrap">
                                        <div class="form-grp checkbox-grp">
                                            <label for="checkbox">By Signing up you agree to our  <a href="#">Terms and Condition</a> </label>
                                        </div>
                                    </div>
                                    ...
                                    <span>Already have an account?  <a href="/login">Sign up for free</a> </span>
                                </form>
                            </div>
                        </div>
                        <div class="col-lg-7">
